...
// Keep authored files readable and optimize only the production output.
...
for(const path of ['script.js','assets/js/site.js','assets/js/green-flux.mjs','preventivo/wizard.mjs']){
